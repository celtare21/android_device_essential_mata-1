...
/dev/block/bootdevice/by-name/userdata   /data              f2fs   noatime,nosuid,nodev,nodiratime,fsync_mode=nobarrier,background_gc=off,discard   latemount,wait,check,formattable,encryptable=footer,quota,reservedsize=128M
